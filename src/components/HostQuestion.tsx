...
// // Updated Question type to include 'multi'
// interface Question {
//   text: string;
...
// export default function HostQuestion() {
//   const { gameCode, questionIndex } = useParams<{ gameCode: string; questionIndex: string }>();
//   const navigate = useNavigate();
...
//           {!showScoreboard ? (
//             <>
//               {/* Only pass the props QuestionCard expects */}
//               <QuestionCard question={question} timeLeft={timeLeft} />
//               {timeLeft <= 0 && (
//                 <button
//                   onClick={revealScoreboard}
//                   className="mt-6 bg-blue-500 hover:bg-blue-600 px-6 py-3 rounded-xl text-white font-semibold"
